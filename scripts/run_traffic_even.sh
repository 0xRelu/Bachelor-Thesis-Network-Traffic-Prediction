python LtsfExperiment.py -s -o ~/BA/BA_LTSF_w_Transformer/conf/traffic_even/baseline/config_dlinear.yaml
...
python LtsfExperiment.py -s -o ~/BA/BA_LTSF_w_Transformer/conf/traffic_even/transformer/config_vanilla.yaml

python LtsfExperiment.py -s -o ~/BA/BA_LTSF_w_Transformer/conf/traffic_even/transformer/config_informer.yaml
