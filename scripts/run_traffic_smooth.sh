python LtsfExperiment.py -s -o ~/BA/BA_LTSF_w_Transformer/conf/smooth/baseline/config_dlinear.yaml

python LtsfExperiment.py -s -o ~/BA/BA_LTSF_w_Transformer/conf/smooth/baseline/config_linear.yaml
...
python LtsfExperiment.py -s -o ~/BA/BA_LTSF_w_Transformer/conf/smooth/transformer/config_informer.yaml
